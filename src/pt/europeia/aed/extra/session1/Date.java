...
public final class Date implements Comparable<Date> {
    ...
    public static final Comparator<Date> reverseComparator = new ReverseDateComparator();
    ...
    private static class ReverseDateComparator implements Comparator<Date> {
        ...
        @Override
        public int compare(final Date first, final Date second) {
